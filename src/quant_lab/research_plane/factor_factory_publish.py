...
def publish_factor_factory_generation(
    ...
    try:
        ...
        generation_payload = {
            ...
            "feature_input_digest": validated.snapshot.feature_input_digest,
            "market_input_digest": validated.snapshot.market_input_digest,
            ...
            "combined_input_digest": validated.snapshot.combined_input_digest,
...
def record_factor_factory_no_update_state(
    ...
    payload = {
        "schema_version": "factor_factory_no_update_state.v2",
        "snapshot_id": manifest.snapshot_id,
        "task_id": manifest.task_id,
        "factor_plan_digest": manifest.factor_plan_digest,
        ...
        "reason": "factor_factory_input_still_empty",
        "worker_no_update_reason": manifest.no_update_reason,
