...
KNOWN_FILE_PATTERNS = [
    ...
    re.compile(r"^summaries/expanded_universe_advisory_reader\.csv$"),
    re.compile(r"^summaries/expanded_universe_paper_runs\.csv$"),
    re.compile(r"^summaries/expanded_universe_paper_daily\.csv$"),
    ...
    re.compile(r"^reports/cost_probe_(summary|p3_preflight)\.json$"),
    re.compile(r"^summaries/cost_probe_(summary|p3_preflight)\.json$"),
    re.compile(r"^raw/reports/cost_probe_(summary|p3_preflight)\.json$"),
    re.compile(r"^reports/(runtime_cost_guard|cost_disagreement)\.csv$"),
    re.compile(r"^summaries/cost_probe_(runtime_cost_guard|cost_disagreement)\.csv$"),
    re.compile(r"^raw/reports/(runtime_cost_guard|cost_disagreement)\.csv$"),
