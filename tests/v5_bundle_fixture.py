    ...
    *,
    ...
    files = {
        ...
        "summaries/cost_probe_p3_preflight.json": (
            '{"generated_at": "2026-05-10T01:02:00Z", '
            '"state": "NOT_READY", '
            '"offline_plan_state": "NO_PLAN_ROWS", '
            '"online_exchange_preflight_state": "NOT_READY", '
            '"effective_preflight_state": "NOT_READY", '
            ...
            '"manual_probe_symbol": "", '
            '"manual_allowed_symbols": ["BTC/USDT", "ETH/USDT", "SOL/USDT", "BNB/USDT"], '
            '"manual_max_notional_usdt": 5.0, '
            '"manual_required_exit_policy": "immediate_flat", '
            '"manual_max_open_seconds": 60, '
            '"planned_symbols": [], '
            '"blockers": ["dry_run_plan_not_ready"], '
            '"runtime_blockers": [], '
            '"guard_failures": [], '
            '"dry_run_plan_state": "DISABLED", '
            '"dry_run": true, '
            '"live_enabled": false, '
            '"no_order_submitted": true, '
            '"next_action": "fix_preflight_blockers_before_requesting_live_probe", '
            '"post_probe_required_evidence": ["order_id", "roundtrip_flat_confirmed"]}'
        ),
